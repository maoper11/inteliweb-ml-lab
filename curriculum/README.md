...
Each course is independent and must include:
...
The installer copies missing files into `app/workspace/courses` without overwriting files already modified by the student.
